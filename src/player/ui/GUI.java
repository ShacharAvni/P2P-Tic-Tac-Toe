...
public final class GUI extends JFrame implements ActionListener
{
   ...
   //This mutex is so no synchronization errors occur when accessing various GUI
   //elements
   ...
   /*
    * This enum is used when other objects call the GUI methods which show dialogs.
    * It is a wrapper around the JOptionPane enum which selects the icon shown in a
    * dialog.
    */
   ...
   /*
    * GUI Constructor. It places all the menus and GUI objects on the main panel into their
    * respective locations, as well as sets up the action listeners for the appropriate objects.
    */
   ...
   /*
    * Closes the latch so that the main thread can start
   ...
   /*
    * Allows the player to forfeit a match if canForfeit is true or nullifies their ability
    * otherwise. This method is called by the PlayerNode.
    */
   ...
   /*
    * Add the move made by the opposing player to the game board. This
    * method is called from the PlayerNode class. There should be only
    * one Move coming at a time from the opposing player. Hence, this
   ...
   /*
    * Updates the label above the player list to show the current Registry connection
    * status.
    */
   ...
   /*
    * Displays "msg" in a modal dialog in a separate thread. "type" is used to select which
    * icon will be used in the dialog. This method is called when the dialog is only showing
    * a status update and thus does not need to block.
    */
   ...
   /*
    * Asks the user for a URL in a dialog. "message" is the text to be
    * shown above the text box. "defaultText" is the text to be shown
    * within the text box. This method is called from the PlayerNode class.
    */
   ...
   public void actionPerformed(final ActionEvent e)
   {
      if(e.getSource() == playButton)
      {
         ...
         {
            playerNode.tryPlay((String)playerList.getSelectedValue());
         }
      }
